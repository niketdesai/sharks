 ...
 *   lr = last year of deal, RFA after (team has rights)
 *   lu = last year of deal, UFA after (player walks)
 *   r  = projected extension / new deal (not yet signed)
 *   f  = TBD / open slot
 */
...
export const YEARS = [
  // ────────────────────────── 25-26 ──────────────────────────
  {
    ...
    lines: {
      ...
      L2: [ p("Eklund","W",23,0.9,"lr",["PP2"]),          // ELC last yr; RFA. Bridge signed. Trading.
            p("Wennberg","C",31,5.0,"x",["PK"]),           // $5M yr1/2; ext kicks in 26-27
    ...
    extras: [
      p("Graf","W",23,0.9,"lr"),    // ELC last yr; RFA
  ...
  // ────────────────────────── 26-27 ──────────────────────────
  {
    ...
    cap: 104.0, dead: 4.1,
    lines: {
      L1: [ p("Chernyshov","W",21,0.9,"e"),                // ELC yr2/3
      ...
      G:  [ p("Askarov","G",24,2.0,"lr"),                  // $2M last yr; RFA. Extending proactively.
  ...
  // ────────────────────────── 27-28 ──────────────────────────
  {
    ...
    cap: 113.5, dead: 1.4,
    lines: {
      L1: [ p("Chernyshov","W",22,0.9,"lr"),               // ELC last yr; RFA
