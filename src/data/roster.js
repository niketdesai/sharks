...
export const YEARS = [
  ...
  // ────────────────────────── 26-27 ──────────────────────────
  {
    ...
    cap: 104.0, dead: 4.1,
    lines: {
      L1: [ p("Chernyshov","W",21,0.9,"e",["PK1"]),
            p("Celebrini","C",20,1.0,"lr",["C","PP1","GOAT"]),
            p("Smith","W",21,1.0,"lr",["PP1"]) ],
  ...
  // ────────────────────────── 27-28 ──────────────────────────
  {
    ...
    cap: 113.5, dead: 1.4,
    lines: {
      L1: [ p("Chernyshov","W",22,0.9,"lr",["PK1"]),
            p("Celebrini","C",21,12.0,"r",["C","PP1","GOAT"]),
            p("Smith","W",22,9.0,"r",["PP1"]) ],
      L2: [ tbd("LW — TBD",5.0),
      ...
      L4: [ tbd("LW — depth",1.5),
            p("Ostapchuk","C",24,1.5,"x",["PK2"]),
            tbd("RW — depth",1.0) ],
      D1: [ p("Dickinson","D",22,0.9,"lr",["PP1"]),
            tbd("RD — top pair",6.0) ],
  ...
  // ────────────────────────── 28-29 ──────────────────────────
  {
    ...
    cap: 123.0, dead: 1.4,
    lines: {
      L1: [ p("Chernyshov","W",23,4.0,"r",["PP1","PK1"]),
            p("Celebrini","C",22,12.0,"r",["C","PP1","GOAT"]),
